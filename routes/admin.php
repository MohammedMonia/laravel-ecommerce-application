...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::group(['prefix' => 'attributes'], function () {
            ...
            Route::post('/update/{id}', 'Admin\AttributeController@update')->name('admin.attributes.update');
            Route::get('/{id}/delete', 'Admin\AttributeController@destroy')->name('admin.attributes.delete');
        ...
        Route::group(['prefix' => 'brands'], function () {
            ...
            Route::post('/update/{id}', 'Admin\BrandController@update')->name('admin.brands.update');
            Route::get('/{id}/delete', 'Admin\BrandController@destroy')->name('admin.brands.delete');
